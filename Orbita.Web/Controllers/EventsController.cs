...
public sealed class EventsController(IEventsService events) : Controller
{
    ...
    {
        var model = await events.GetIndexAsync(q, type, workerId, accountId, level, view, severity, page, pageSize, sort, dir, ct);
    ...
    public async Task<IActionResult> Index(
        ...
        CancellationToken ct = default)
    {
        var model = await events.GetIndexAsync(q, type, workerId, accountId, level, view, severity, page, pageSize, sort, dir, ct: ct);
        return View(model);
    }
