(function () {
    ...
    var snapshotFetcher = shared && shared.createSnapshotFetcher
        ? shared.createSnapshotFetcher('events', function (payload) { applySnapshot(payload, true); }, { errorName: 'Events' })
        : null;

    function initEventsPage() {
        if (shared && shared.registerLivePage) {
            shared.registerLivePage('events', snapshotFetcher, function () {
                initKpiCounters();
