(function () {
    ...
    function initLeadFlowImport() {
        const form = document.querySelector('[data-leadflow-import-form]');
        if (!form || form.__orbitaLeadflowInit) return;
        form.__orbitaLeadflowInit = true;
    ...
    initLeadFlowImport();
    document.addEventListener('orbita:content-updated', initLeadFlowImport);
})();