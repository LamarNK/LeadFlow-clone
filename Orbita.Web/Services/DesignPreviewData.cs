            ...
            new()
                {
                    ...
                    Delta = "+12.4%",
                    DeltaTone = "good",
                    Rate = DashboardRateFormatter.Format(1234, period, Now, "откл."),
                ...
                new()
                {
                    ...
                    Delta = "За период",
                    DeltaTone = "neutral",
                    Rate = DashboardRateFormatter.Format(978, period, Now, "уник."),
                ...
                new()
                {
                    ...
                    Delta = "89.1%",
                    DeltaTone = "good",
                    Rate = DashboardRateFormatter.Format(1100, period, Now, "отпр."),
                ...
                new()
                {
                    ...
                    Delta = "-5.3%",
                    DeltaTone = "good",
                    Rate = DashboardRateFormatter.Format(256, period, Now, "дуб."),
                ...
                new()
                {
                    ...
                    Delta = "+2.1%",
                    DeltaTone = "bad",
                    Rate = DashboardRateFormatter.Format(18, period, Now, "ош."),
