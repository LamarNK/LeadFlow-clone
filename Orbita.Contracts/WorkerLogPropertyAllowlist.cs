...
public static class WorkerLogPropertyAllowlist
{
    private static readonly HashSet<string> Allowed = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "candidates.prepare.domItemCount",
        "candidates.prepare.cardsWithPhone",
        "candidates.prepare.phonesReady",
        "candidates.prepare.maskedPhonesLeft",
        "candidates.prepare.phoneRevealRounds",
        ...
        "candidates.prepare.cardFingerprintSkips",
        "candidates.prepare.phoneSkips",
        "candidates.prepare.profileSkips",
        "candidates.prepare.collectionFilterSkips",
        "candidates.prepare.totalMs",
        "candidates.prepare.firewallMs",
        "candidates.prepare.scrollMs",
        "candidates.prepare.postScrollMs",
        "candidates.prepare.priorityMs",
        "candidates.prepare.phoneRevealMs",
        "candidates.prepare.detailEnrichMs",
        "candidates.prepare.scrollDomCalls",
        "candidates.prepare.scrollStepCalls",
        "candidates.prepare.scrollProfileProbeCalls",
        ...
        "candidates.pipeline.messengerMs",
        "candidates.pipeline.totalMs"
    };
