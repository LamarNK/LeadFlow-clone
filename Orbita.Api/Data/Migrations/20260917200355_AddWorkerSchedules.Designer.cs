...
namespace Orbita.Api.Data.Migrations
{
    ...
    [Migration("20260917200355_AddWorkerSchedules")]
    partial class AddWorkerSchedules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orbita.Api.Data.CaptchaProviderRequestEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool?>("ChallengePresent")
                        .HasColumnType("boolean");

                    b.Property<int?>("ContextAgeAtSubmitMs")
                        .HasColumnType("integer");

                    b.Property<int?>("ContextAgeAtVerifyMs")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid?>("DiagnosticAttachmentId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool?>("RiskTypePresent")
                        .HasColumnType("boolean");

                    b.Property<int?>("SolveDurationMs")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid?>("SubProfileRunId")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("SubmittedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("TargetHttpStatus")
                        .HasColumnType("integer");

                    b.Property<string>("TargetReason")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("Stage", "ProviderStatus", "TargetStatus");

                    b.HasIndex("WorkerId", "AccountId", "SubmittedAtUtc");

                    b.ToTable("CaptchaProviderRequests");
                });
            ...
            modelBuilder.Entity("Orbita.Api.Data.MonitoringSubProfileRunEntity", b =>
                {
                    ...
                    b.Property<int>("SkippedNoPhoneCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Orbita.Api.Data.TopUpSessionEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("HistoryConfirmedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("HistoryOperationAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Orbita.Api.Data.WorkerAvitoAdEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("DetailCheckedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("LastSuccessfulListCheckAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("PublicationDateSource")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.HasIndex("WorkerId", "AccountId", "IsActive");

                    b.HasIndex("WorkerId", "AccountId", "AvitoSubProfileId", "AvitoItemId")
                        .IsUnique();

                    b.ToTable("WorkerAvitoAds", (string)null);
                });

            modelBuilder.Entity("Orbita.Api.Data.WorkerAvitoAdListScheduleEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("LastSuccessfulCheckAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("NextCheckAtUtc");

                    b.HasIndex("WorkerId", "AccountId", "AvitoSubProfileId")
                        .IsUnique();

                    b.ToTable("WorkerAvitoAdListSchedules", (string)null);
                });
            ...
            modelBuilder.Entity("Orbita.Api.Data.WorkerScheduleAssignmentEntity", b =>
                {
                    b.Property<Guid>("WorkerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GroupId", "Shift");

                    b.ToTable("WorkerScheduleAssignments", (string)null);
                });

            modelBuilder.Entity("Orbita.Api.Data.WorkerScheduleGroupEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("CurrentWeekShift")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");
                    ...
                    b.Property<DateOnly?>("LastAppliedOffDate")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("OfficeId", "DayOff")
                        .IsUnique();

                    b.ToTable("WorkerScheduleGroups", (string)null);
                });

            modelBuilder.Entity("Orbita.Api.Data.WorkerScheduleOfficeEntity", b =>
                {
                    b.Property<Guid>("OfficeId")
                        .HasColumnType("uuid");

                    b.Property<string>("DayEndLocalTime")
                        .IsRequired()
                        .HasMaxLength(5)
                        .HasColumnType("character varying(5)");

                    b.Property<string>("DayStartLocalTime")
                        .IsRequired()
                        .HasMaxLength(5)
                        .HasColumnType("character varying(5)");

                    b.Property<string>("NightEndLocalTime")
                        .IsRequired()
                        .HasMaxLength(5)
                        .HasColumnType("character varying(5)");

                    b.Property<string>("NightStartLocalTime")
                        .IsRequired()
                        .HasMaxLength(5)
                        .HasColumnType("character varying(5)");
                    ...
                    b.ToTable("WorkerScheduleOffices", (string)null);
                });
            ...
            modelBuilder.Entity("Orbita.Api.Data.WorkerScheduleAssignmentEntity", b =>
                {
                    b.HasOne("Orbita.Api.Data.WorkerScheduleGroupEntity", "Group")
                    ...
                    b.HasOne("Orbita.Api.Data.WorkerEntity", "Worker")
                        .WithOne("ScheduleAssignment")
                        .HasForeignKey("Orbita.Api.Data.WorkerScheduleAssignmentEntity", "WorkerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Orbita.Api.Data.WorkerScheduleGroupEntity", b =>
                {
                    b.HasOne("Orbita.Api.Data.WorkerScheduleOfficeEntity", "Office")
                        .WithMany("Groups")
                        .HasForeignKey("OfficeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Orbita.Api.Data.WorkerScheduleOfficeEntity", b =>
                {
                    b.HasOne("Orbita.Api.Data.OfficeEntity", "Office")
                        .WithOne()
                        .HasForeignKey("Orbita.Api.Data.WorkerScheduleOfficeEntity", "OfficeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
